      ...
      <div className="mx-auto w-full max-w-[1500px] px-6 py-16">
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-6 max-w-md text-sm leading-7 text-slate-400">
              A sua loja de confiança para recargas de diamantes,
              passes e produtos para Free Fire. Rápido, seguro e
              com os melhores preços em Kwanzas.
            </p>
        ...
        >
          <p className="text-xs text-slate-500">
            © {new Date().getFullYear()} Faby Shop. Todos os direitos reservados.
          </p>
